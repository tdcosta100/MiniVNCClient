...
{
    /// <summary>
    /// Codes of VNC encodings (positive codes) and pseudo-encodings (negative codes)
    /// </summary>
    public enum VNCEncoding : int
    {
        ...
        VMwareCursor = unchecked(0x574d5664),
        VMwareCursorState = unchecked(0x574d5665),
        VMwareCursorPosition = unchecked(0x574d5666),
        VMwareKeyRepeat = unchecked(0x574d5667),
        VMwareLEDstate = unchecked(0x574d5668),
        VMwareDisplayModeChange = unchecked(0x574d5669),
        VMwareVirtualMachineState = unchecked(0x574d566a),
